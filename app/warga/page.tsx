        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-sm text-gray-600">Kelola data warga RT/RW</p>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Total {filteredWarga.length} warga terdaftar</CardDescription>
          </CardHeader>
          <CardContent>
            {/* Search and Filters */}
                  ...
                  {filteredWarga.length === 0 ? (
                    ...
                    filteredWarga.map((w) => (
                      <TableRow key={w.id}>
                        ...
                        <TableCell>{w.noKK}</TableCell>
                        <TableCell>{w.alamat}</TableCell>
                        <TableCell>
                          <Badge variant={w.jenisKelamin === "Laki-laki" ? "default" : "secondary"}>
                            {w.jenisKelamin}
                          </Badge>
                        </TableCell>
